...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    "Since 2010 we've been more than a dealership — riders ourselves, offering sales, expert servicing, and custom builds.",
};
    ...
    <main className={styles.pageWrapper}>
      ...
      >
        ...
        <div className={styles.mobileImgWrap} aria-hidden="true">
          <img src={aboutImg.src} alt="" className={styles.mobileImg} />
        </div>
