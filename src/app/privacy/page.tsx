...
import { Eye, Database, Cookie, Share2, ShieldCheck, UserCheck } from "lucide-react";

export const metadata: Metadata = {
  title: "Privacy Policy",
  description: "How Dimitar's Motorcycles collects, uses, and protects your personal data.",
};
